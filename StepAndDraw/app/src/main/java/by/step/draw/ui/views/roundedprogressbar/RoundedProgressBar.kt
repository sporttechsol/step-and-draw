...
import by.step.draw.ui.views.roundedprogressbar.ProgressTextOverlay.Companion.DEFAULT_FONT_PATH
import by.step.draw.ui.views.roundedprogressbar.ProgressTextOverlay.Companion.DEFAULT_SHOW_TEXT
import by.step.draw.ui.views.roundedprogressbar.ProgressTextOverlay.Companion.DEFAULT_TRUE_0
import by.step.draw.ui.views.roundedprogressbar.ProgressTextOverlay.Companion.DEFAULT_TRUE_100
...
class RoundedProgressBar @JvmOverloads constructor(
    ...
    @ColorInt
    private val defaultProgressDrawableColor = ContextCompat.getColor(context, R.color.orange_ff9)

    @ColorInt
    private val defaultBackgroundDrawableColor = ContextCompat.getColor(context, R.color.grey_bbb)
    ...
    init {
        ...
        View.inflate(context, R.layout.layout_rounded_progress_bar, this)
        progressBar = rounded_progress_bar
        progressTextOverlay = progress_text_overlay
        progressBar.max =
    ...
    private fun initAttributes(attrs: AttributeSet?) {
        ...
        val newProgressValue = rpbAttributes.getInteger(
            R.styleable.RoundedProgressBar_rpbProgressPercent,
        ...
        val newTrue0 = rpbAttributes.getBoolean(
            R.styleable.RoundedProgressBar_rpbOnlyShowTrue0,
            defaultOnlyShowTrue0
        )
        if (newTrue0 != defaultOnlyShowTrue0) setOnlyShowTrue0(newTrue0)

        // Set the onlyShowTrue100 value
        val newTrue100 = rpbAttributes.getBoolean(
            R.styleable.RoundedProgressBar_rpbOnlyShowTrue100,
            defaultOnlyShowTrue100
        )
    ...
    fun setProgress(value: Int, shouldAnimate: Boolean = true) {
        setProgressPercentage(value.toDouble() / maxValue.toDouble() * 100.0, shouldAnimate)
    }
...
//        savedState.savedMaxValue = maxValue
//        return savedState
//    }
//
