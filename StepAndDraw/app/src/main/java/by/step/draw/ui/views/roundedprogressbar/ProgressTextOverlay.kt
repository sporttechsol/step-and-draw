...
internal class ProgressTextOverlay @JvmOverloads constructor(
    ...
    private val defaultBgTextColor = android.R.color.black
    ...
    private var textSidePadding: Float =
    ...
    override fun onDraw(canvas: Canvas?) {
        if (showProgressText) {
            ...
            if (requiredTextContainerWidth < progressDrawableWidth) { // should use inside position
                ...
                canvas?.drawText(
                    getPercentageString(progressValue, onlyShowTrue0, onlyShowTrue100),
                    xPosition,
                    yPosition,
                    progressTextOverlayPaint
                )
